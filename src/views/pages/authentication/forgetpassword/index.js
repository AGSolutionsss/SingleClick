                        ...
                        <Grid container direction="column" spacing={2} justifyContent="center">
                            ...
                            <Grid item xs={12}>
                                <Grid item container direction="column" alignItems="center" xs={12}>
                                    <Typography component={RouterLink} to="login" variant="subtitle1" className={classes.title} style={{ color:'#868688'}}>
                                        Received/Remember password? <span style={{ textDecoration: 'underline', color: 'blue' }}>Sign in</span>
                                    </Typography>
                                </Grid>
